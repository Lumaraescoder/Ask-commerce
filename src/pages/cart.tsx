        ...
        <div className="flex shadow-md my-10">
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <button className="font-semibold text-left uppercase hover:text-red-500 text-gray-500 text-xs">
                    Remove
                  </button>
                </div>
              </div>
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <span className="font-bold text-xs">Xiaomi</span>
                  <button className="font-semibold text-left uppercase hover:text-red-500 text-gray-500 text-xs">
                    Remove
                  </button>
                </div>
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button className="bg-gray-700 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">
                Checkout
              </button>
            </div>
          </div>
